...
int main() {
  ...
  p1.newDayGrowth();
  std::cout << "The potato plant has hydration level -1:" << p1.get_hydrationLevel() << ", The root plant was seeded 1 day ago:" << p1.get_seedingTime() <<", plant is alive (should be 0):" << p1.get_alive() << std::endl;
