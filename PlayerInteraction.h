...
class PlayerInteraction {
    ...
    public:
        ...
        void seedPlant(int seedType, Player p, std::vector<tile*>* backgroundTiles) { // takes in an int which represents the seed type (from the selected item in inventory), takes in an object player, and a pointer to a vector of pointers to tiles (a pointer to background tiles)
